...
export default function Navbar() {
  ...
  return (
        ...
        <div className="mx-auto flex justify-between max-w-6xl py-7">
            ...
            <ul className="flex space-x-6 justify-between items-center text-gray-900 text-sm">
                ...
                <li><Link to="resources-articles" className="hover:text-[#7e9452]">Resources & Articles</Link></li>
