    ...
    <div className="bg-white py-16">
      <section id="moto" className="mx-4 flex md:mx-8">
        <div className="mx-auto flex w-full max-w-3xl flex-col items-center gap-8">
          ...
          <Link
            to={"/aboutUs"}
            className="mx-auto flex w-full max-w-64 items-center justify-center rounded-full bg-blue-400 px-12 py-3 font-semibold capitalize text-white hover:bg-blue-500"
          >
            Know More
          </Link>
        </div>
